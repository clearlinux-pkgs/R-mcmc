...
Version  : 0.9.6.1
Release  : 24
URL      : https://cran.r-project.org/src/contrib/mcmc_0.9-6.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/mcmc_0.9-6.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1581994254
